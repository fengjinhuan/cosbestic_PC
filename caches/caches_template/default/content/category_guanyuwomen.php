...
<link rel="stylesheet" href="<?php echo CSS_PATH;?>guanyuwomen.css">
	...
	<ul class="con">
        ...
        <li class="list">
            <h1>公司简介</h1>
            <p>当地时间19日晚间，俄罗斯驻土耳其大使卡尔洛夫出席了在安卡拉举行的一场题为《土耳其人眼里的俄罗斯》画展的开幕式，并进行讲话。期间，一名男子突然向其开枪射击，致卡尔洛夫受伤。卡尔洛夫立刻被送入当地医院进行治疗，但最终伤重不治。
                <a href="<?php echo $CATEGORYS['13']['url'];?>">[详情]</a>
            </p>
        </li>
        <li class="list">
